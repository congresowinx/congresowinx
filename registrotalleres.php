                            ...
                            $connC2=pg_query($conexion,$queryC2);
                                        ...
                                        //contador de trabajos por congreso actual
                                            ...
                                            $conta1++;
                                                      ...
                                                      //busca cuantos talleres tiene
                                           $queryTa1=("Select * from talleres where id_trabajos='$idt2'");
                                               $connTa1=pg_query($conexion,$queryTa1);
                                                     if(!$connTa1){
                                                        die(pg_error($conexion));
                                                         }
                                               if (pg_num_rows($connTa1) > 0) {
                                                    while($rowDataTa1 = pg_fetch_array($connTa1)){
                                                         //contabiliza el trabajo de taller
                                                    $conta2++;
                                                    }}
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de resumen para talleres</p>
...
<p class="temaSec">Antes de llenar cada espacio, favor de leer primero las indicaciones detenidamente. </p> <br>
                ...
                <div class="datosP">
                    ...
                    <div class="D1">
                        ...
                        <center>    <tr>
                            ...
                            <table>
                        <br><p class="temaSec">4.- Agregar requisitos técnicos para poder impartirlo.</p>
                        <center>    <tr>
                                <td class="C1">
                                    <label for="Palabras">Requisitos técnicos:</label>
                                </td>
                                <td class="C2">
                                    <textarea class="textarea2" type="text"  name="requisitostecnicos" placeholder="INGRESA LOS REQUISITOS TÉCNICOS DEL TALLER" style="text-transform:uppercase;"></textarea>
                        ...
                        <table>
                        <br><p class="temaSec">5.- Seleccione una categoria.</p>
                        <center>    <tr>
                                <td class="C1">                              
                ...
                <div class="datosP">
                    ...
                    <div class="D1">
                        ...
                        <table>
                          <br><p class="temaSec">6.- Ingrese un correo únicamente por recuadro de texto. Importante: el correo debe estar registrado en el sistema para que el registro de este resumen sea éxitoso.</p>
                ...
                <div class="datosP">
                    ...
                    <!--******REFERENCIAS*******-->
                        ...
                        <table>
                            <br><p class="temaSec">7.- Ingrese una bibliografía únicamente por recuadro de texto. Importante: el correo debe estar registrado en el sistema para que el registro de este resumen sea éxitoso.</p>
                        <center>    <tr>
                            <td class="C1">
...
if(isset($_POST["titulo"]) && isset($_POST["resumen"]) && isset($_POST["palabrasclave"]) && isset($_POST["requisitostecnicos"]) && isset($_POST["categorias"]) && isset($_POST["Correo1"]) && isset($_POST["Correo2"]) && isset($_POST["Correo3"])) {  
                        ...
                        $requisitostecnicos1 = $_POST["requisitostecnicos"];
                        $requisitostecnicos= strtoupper($requisitostecnicos1);
       ...
       if( $Correo5 != ""){
                ...
                $query7=("INSERT INTO talleres (id_trabajos, resumen_ponencia, requisitos_tecnicos)
                          VALUES('$numid','$resumen','$requisitostecnicos')");
