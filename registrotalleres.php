<html lang="es">
    <head>
        ...
        <title>Resumen para talleres</title>
       <meta charset="UTF-8">
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de resumen para taller</p>
                ...
                <div class="datosP">
                    ...
                    <div class="D1">
                        ...
                        <center>    <tr>
                            ...
                            <center><tr>
                                ...
                                <td class="C2">
                                    ...
                                    <textarea class="textarea3" type="text"  name="referencia" placeholder="INGRESA RESUMEN DEL TALLER" style="text-transform:uppercase;"required></textarea>
                        ...
                        <center>    <tr>
                                ...
                                <td class="C2">
                                    <textarea class="textarea2" type="text" name="palabrasclave" placeholder="INGRESA PALABRAS CLAVE DEL TALLER" style="text-transform:uppercase;"required></textarea>
                ...
                <p class="temaCentral">Contenido y materiales</p>
                    ...
                    <div class="D1">
                        ...
                        <center><tr>
                                ...
                                <td class="C2">
                                    ...
                                    <textarea class="textarea3" type="text"  name="referencia" placeholder="INGRESA CONTENIDO DEL TALLER" style="text-transform:uppercase;"required></textarea>
                                    <!--<textarea  type="text" name="resumen" placeholder="Ingresa resumen"  required> </textarea>-->
                            ...
                            <center>    <tr>
                                <td class="C1">
                                    <label for="Palabras">Materiales:</label>
                                </td>
                                <td class="C2">
                                    <textarea class="textarea2" type="text" name="palabrasclave" placeholder="INGRESA MATERIALES PARA EL TALLER" style="text-transform:uppercase;"required></textarea>
