...
<html lang="es">
    <head>
        ...
        <title>Corrección de resumen taller</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de corrección resumen para taller</p>
                ...
                <div class="datosP">
                    ...
                    <div class="D1">
                        ...
                        <center>    <tr>
                                ...
                                <td class="C2">
                                    <textarea class="textarea2" type="text"  name="requisitostecnicos" placeholder="INGRESA LOS REQUISITOS TÉCNICOS DEL TALLER" style="text-transform:uppercase;"required></textarea>
