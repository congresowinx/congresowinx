...
<main>
 ...
 <div class="contenido">
        <h1 class=".hh1">Resumen a evaluar: </h1>
        <form>
        ...
        <table align="center" class="table1">
           ...
           <tr>
                <td>1. Título (Máximo 15 palabras) </td>
                <td><div id="product1">
           ...
           <tr>
                <td>3. Contenido (Máximo 300 palabras estructurado de acuerdo a la categoría seleccionada) </td>
                <td><div id="product3">
           ...
           <tr>
                <td>4. Referencias en estilo APA (Máximo 500 palabras.) </td>
                <td><div id="product4">
        ...
        <table align="center" class="table2">
            <tr>
               <td colspan="3">Observaciones Generales</td>
               <td></td>
               <td></td>
           </tr>
           <tr>
               <td colspan="3"><textarea class="txa1" rows="8"></textarea></td>
           </tr>
           
           <tr>
               <td colspan="3">Máximo 40 palabras. CAMPO OBLIGATORIO</td>
           </tr>
        </table>
            </div>
        ...
        <table align="center" class="table3">
            <tr>
                <td><button class="b1">Aceptar</button></td>
                <td><button class="b2">Regresar</button></td>
                <td><button class="b3">Enviar</button></td>
            </tr>
            <tr>
                <td colspan="2"></td>
            </tr>
    ...
    <script type="text/javascript" src="js/minerkill.js"></script>
