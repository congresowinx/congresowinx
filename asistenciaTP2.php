  ...
  <div class="ContenedorPrincipal">
    <div class="px-4 pt-5 my-5 text-center border-bottom">
      ...
      <div class="col-lg-6 mx-auto">
                            ...
                            ?>
                                <tr class="inputNombreC2">
                                  ...
                                  <th class="inputNombreC2">
                                    <button name="uploadBtnMesa" class="enviarBtn" value="Asistir" >Asistir</button> </a>
                                  </th>
                                </tr> <?php }
                                  }  ?>
                        ...
                        <table class="table table-bordered border border-secondary">
                          <center>
                            <table class="inputNombreC">
                              ...
                              ?>
                                  <tr class="inputNombreC2">
                                    <td class="inputNombreC2"><?php echo $rowData3["exposicion_id"] ?></td>
                                    ...
                                    <th class="inputNombreC2">
                                      <button class="enviarBtn" onclick="getElementsByTagName('textareaa').readonly;">Asistir</button></a>
                                    </th>
                                  </tr> <?php }
                                    }  ?>
        ...
        <div> <a href="menu.php"> <button class="enviarPagoBtn">Regresar</button></div>
      </div>
    </div>
  </div>
  </div>
  <div>
    ...
    if (isset($_POST['uploadBtnMesa']) && $_POST['uploadBtn'] == 'Asistir') {
      ...
      if (isset($_POST["id_expo"]) && isset($_POST["fecha"])) {
        ...
        $query5 = "SELECT * FROM usuario_asiste_ponencia WHERE ponencia_id ='$id_exposicion'";
        ...
        window.location.replace('https://laboratoriosistemas.cuautitlan2.unam.mx/congresowinx/WinxCongreso/asistenciaTP.php');</script>";
          ...
          $query6 = ("INSERT INTO pagos (usuario_id, ponencia_id, fecha) 
          VALUES ('$varId2','$id_exposicion', '$fecha')");
