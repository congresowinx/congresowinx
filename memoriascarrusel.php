...
<div class ="row align-items-start">
            <?php
$anioA1 = date('Y') - 1;
echo "<div class='col-6 col-sm-3'><p class='btn btn-warning'><a href='memoriascarrusel1.php' class='btn btn-default'> ".$anioA1." </a></div>";

$anioA2 = date('Y') - 2;
echo "<div class='col-6 col-sm-6'><p class='btn btn-warning'><a href='memoriascarrusel2.php' class='btn btn-default'> ".$anioA2." </a></div>";


$anioA3 = date('Y') - 3;
echo "<div class='col'><p class='btn btn-warning'><a href='memoriascarrusel3.php' class='btn btn-default'> ".$anioA3." </a></div>";
?>
</div>
</center>     
     ...
     $fotos  = scandir('memorias/memorias0');
       foreach ($fotos as $foto) 
        ...
        if (str_contains($foto, '.jpg') || str_contains($foto, '.jpeg') || str_contains($foto, '.png')) {
            $htmlImagen = "<div class=\"gallery_item :nth-of-type \"><div class=\"gallery_item\"><div class=\"Imagen\"> <img src=\"memorias/memorias0/" . $foto . "\"></div></div></div>";
            echo $htmlImagen;
        }
       }
