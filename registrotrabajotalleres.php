...
$query2 = ("UPDATE talleres SET contenido = '$contenido' WHERE id_trabajos = '123011515'"); //el numerito es el id de un taller
...
$query3 = ("INSERT INTO materiales (nombre_material) VALUES ('$materiales')");
...
$query4 = ("Select * from materiales where nombre_material='$materiales' ");
...
$query5 = ("INSERT INTO talleres_material (taller_id, material_id) VALUES ('123011515','$id_material')");
$consulta3=pg_query($conexion,$query5); //ejecuta la acción query en la BD


// Avisa al usuaro que el archivo se cargo con exito
echo "<div class='alert alert-success'><p class='hidd' align=center>Su registro se ha cargado correctamente. <a href='registrotrabajotalleres.php' class='btn btn-default'>Clic aquí </a> para finalizar.</div>"; 
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de Taller</p>
  ...
  <table>
                        ...
                        <center> <tr>
                               <tr> <p class="temaSec">1.- Ingresa el contenido de tu taller.</p> </tr> <td class="C1">
                                ...
                                <td class="C2">
                               <br><textarea class="textarea2"  type="text"  name="contenido" placeholder="INGRESA LEL CONTENIDO DEL TALLER" required></textarea> 
                                </td>
                                                    </tr> </center>
