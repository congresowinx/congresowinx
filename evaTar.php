...
<html lang="es">
    <head>
        ...
        <title>Evaluacion de Taller </title>
       <meta charset="UTF-8"> 
    ...
    <div class="col-lg-6 mx-auto justify-content: center;">
        ...
        <form>
            ...
            <embed id="vistaPrevia" type="application/pdf" width="150%" height="500">
                            ...
                            <br>
				<p class="temaCentral">Taller a evaluar </p>
				<div class="datosP">					                                        
                                        <div class="D1">
						<table>	
							...
							<tr>
								<td class="C3">
									<label for="Name">1. Título (máximo 15 palabras). El título deberá reflejar el contenido del taller. 	</label>
								</td>
							...
							<tr>
								<td class="C3">
									<label for="Name">2. Contenido (máximo 300 palabras) describir el objetivo, las actividades a realizar y los logros que se pretenden alcanzar. </label>
								</td>
								...
								<td class="C5"><div id="product2">
                                    ...
                                    <input type="checkbox" value="2" id="product-2-2" name="check">
                            																		...
                            																		<tr>
								<td class="C3">
									<label for="Name">3. Materiales (máximo 100 palabras), software necesario, el horario propuesto (opcional) y la tecnología en línea que utilizará (Zoom, Meet, Webex, Classroom, otro).</label>
								</td>
