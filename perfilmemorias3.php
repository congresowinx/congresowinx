...
<div class ="row align-items-start">
            <?php
$anioA1 = date('Y');
echo "<div class='col-6 col-sm-3'><p class='btn btn-warning'><a href='perfilmemorias.php' class='btn btn-default'> ".$anioA1." </a></div>";

$anioA2 = date('Y') - 1;
echo "<div class='col-6 col-sm-6'><p class='btn btn-warning'><a href='perfilmemorias1.php' class='btn btn-default'> ".$anioA2." </a></div>";


$anioA3 = date('Y') - 2;
echo "<div class='col'><p class='btn btn-warning'><a href='perfilmemorias2.php' class='btn btn-default'> ".$anioA3." </a></div>";
?>
</div>
</center>
