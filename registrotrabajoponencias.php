...
$query2 = ("UPDATE ponencia SET extenso_doc= '$Nombrearchivo', video_url = '$url' WHERE id_trabajos = '123125200'"); //el numerito es el id de una ponencia
...
<html lang="es">
    <head>
        ...
        <title>Registro de Extensos</title>
       <meta charset="UTF-8">  
...
<div class="ContenedorPrincipal"> 
 ...
 <?php
  ...
  ?>
        <p class="Tema">Registro de Extensos</p>
