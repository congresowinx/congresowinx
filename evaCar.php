...
<html lang="es">
    <head>
        ...
        <title>Evaluacion de Cartel</title>
       <meta charset="UTF-8"> 
...
<div class="contenedorregistroI"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    <div class="col-lg-6 mx-auto justify-content: center;">
          ...
          <p class="Tema">Cartel a evaluar</p>
            ...
            <embed id="vistaPrevia" type="application/pdf" width="150%" height="500">
				...
				<div class="datosP">					                                        
						...
						<table>	
							...
							<tr>
								<td class="C3">
									<label for="Name">2. Resumen  </label>
								</td>
								...
								<td class="C5"><div id="product2">
                                    ...
                                    <input type="checkbox" value="2" id="product-2-2" name="check">
                            																		...
                            																		<tr>
								<td class="C3">
									<label for="Name">3. Palabras Clave </label>
								</td>
								...
								<td class="C5"><div id="product3">
                                    ...
                                    <input type="checkbox" value="2" id="product-3-2" name="check">
																									                            ...
																									                            <tr>
								<td class="C3">
									<label for="Name">4. Introducción </label>
								</td>
								...
								<td class="C5"><div id="product4">
                                    ...
                                    <input type="checkbox" value="2" id="product-4-2" name="check">
																										                            ...
																										                            <tr>
								<td class="C3">
									<label for="Name">5. Metodología  </label>
								</td>
								
								<td class="C5"><div id="product5">
                                    <input type="checkbox" value="1" id="product-5-1" name="check">
                                    </div></td>
                                    <td class="C5"><div id="product5">
                                    <input type="checkbox" value="2" id="product-5-2" name="check">
                                    </div>
                                </td>
							</tr>					
                            																		...
                            																		<tr>
								<td class="C3">
									<label for="Name">6. Resultados  </label>
								</td>
								
								<td class="C5"><div id="product6">
                                    <input type="checkbox" value="1" id="product-6-1" name="check">
                                    </div></td>
                                    <td class="C5"><div id="product6">
                                    <input type="checkbox" value="2" id="product-6-2" name="check">
                                    </div>
                                </td>
							</tr>	
																									                            ...
																									                            <tr>
								<td class="C3">
									<label for="Name">7. Discusiones y/o Conclusiones  </label>
								</td>
								
								<td class="C5"><div id="product7">
                                    <input type="checkbox" value="1" id="product-7-1" name="check">
                                    </div></td>
                                    <td class="C5"><div id="product7">
                                    <input type="checkbox" value="2" id="product-7-2" name="check">
                                    </div>
                                </td>
							</tr>
																											                             ...
																											                             <tr>
								<td class="C3">
									<label for="Name">8. Referencias en formato APA  </label>
								</td>
								
								<td class="C5"><div id="product8">
                                    <input type="checkbox" value="1" id="product-8-1" name="check">
                                    </div></td>
                                    <td class="C5"><div id="product8">
                                    <input type="checkbox" value="2" id="product-8-2" name="check">
                                    </div>
                                </td>
							</tr>					
                            																		...
                            																		<tr>
								<td class="C3">
									<label for="Name">9. Imagenes numeradas  </label>
								</td>
								
								<td class="C5"><div id="product9">
                                    <input type="checkbox" value="1" id="product-9-1" name="check">
                                    </div></td>
                                    <td class="C5"><div id="product9">
                                    <input type="checkbox" value="2" id="product-9-2" name="check">
                                    </div>
                                </td>
							</tr>	
																									                            ...
																									                            <tr>
								<td class="C3">
									<label for="Name">10. Formato PDF  </label>
								</td>
								
								<td class="C5"><div id="product10">
                                    <input type="checkbox" value="1" id="product-10-1" name="check">
                                    </div></td>
                                    <td class="C5"><div id="product10">
                                    <input type="checkbox" value="2" id="product-10-2" name="check">
                                    </div>
                                </td>
							</tr>																				
						</table>
