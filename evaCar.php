...
<main>
 ...
 <div class="contenido">
        <h1 class=".hh1">Cartel a evaluar: </h1>
        <form>
        ...
        <table align="center" class="table1">
           ...
           <tr>
                <td>7. Discusiones y/o Conclusiones </td>
                <td><div id="product4">
                   <input type="checkbox" value="1" id="product-4-1" name="check">
               </div></td>
               <td><div id="product4">
           ...
           <tr>
                <td>8. Referencias en formato APA </td>
                <td><div id="product4">
                   <input type="checkbox" value="1" id="product-4-1" name="check">
               </div></td>
               <td><div id="product4">
