...
<div class="contenedorregistroI"> 
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    ...
    <p class="Tema">Recuperar Contraseña</p>

			<form action="#" method="POST" >

				<p class="temaCentral">Genera una nueva contraseña</p>
				...
				<div class="datosP">
						...
						<table>
							...
							<tr>
								<td class="C1">
									<label for="Emails"> Ingresa tu Correo:</label>
								</td>
								<td class="C2">
...
<br>
				<button class="enviarBtn">Cambiar Contraseña</button>
			</form>
