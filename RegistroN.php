...
Encabezado de la página */
    ...
    <!-- Barra de menu Secundario - Movil-->
       ...
       <div class="nav-bar" >
            <a href="#" class="icond icon-book" target="_blank"> </a>
            <a href="#" class="icond icon-file-text2" target="_blank"> </a>
            <a href="#" class="icond icon-mic" target="_blank"> </a>
            <a href="#" class="icond icon-stack" target="_blank"> </a>
            <a href="#" class="icond icon-key" target="_blank"> </a>
            <a href="#" class="icond icon-hearth" target="_blank"> </a>
        </div>   
...
<tr> 
						...
						<tr>
								...
								<td class="C2">
									...
									-->  
                                                                        <input id="phone" class="inputP" type="tel" name="phone" pattern="+[0-9]{14}" maxlength="14" onkeypress="numfinal()" required>
							...
							<tr>
								...
								<td class="C2">
									<input class="inputP" id="passwordV1" type="password"  name="contraseña" placeholder="Máximo 10 caracteres" required minlength="8" maxlength="10" reuired>
							...
							<tr>
								...
								<td class="C2">
									<input class="inputP" id="passwordV2" type="password" name="contraseña2" placeholder="Máximo 10 caracteres" minlength="8" maxlength="10" required>
