...
?>
 ...
 <div class="contenedoramarillo">
      <h1><center>Fotos y videos del Congreso de Matemáticas</center></h1>
          <h1><center> <?php echo date('Y')-1; ?> </center></h1>
     ...
     $fotos  = scandir('memorias/memorias1');
       foreach ($fotos as $foto) 
        ...
        if (str_contains($foto, '.jpg') || str_contains($foto, '.jpeg') || str_contains($foto, '.png')) {
            $htmlImagen = "<div class=\"gallery_item :nth-of-type \"><div class=\"gallery_item\"><div class=\"Imagen\"> <img src=\"memorias/memorias1/" . $foto . "\"></div></div></div>";
            echo $htmlImagen;
        }
       }
