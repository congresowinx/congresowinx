<html lang="es">
    <head>
        ...
        <title>Menu del Perfíl de Evaluador</title>
       <meta charset="UTF-8"> 
    ...
    <!-- Barra de menu Secundario - Movil-->
       ...
       <div class="nav-bar" >
           <a onClick="return ico2()"class="icond icon-book" target="_blank"> <img src="img/icons8-usuario-16.png"/> </a>
            ...
            <a onClick="return ico3()" href="#" class="icond icon-key" target="_blank"> <img src="img/icons8-configuración-del-administrador-16.png"/> </a>
            <a onClick="return ico6()" href="#" class="icond icon-hearth" target="_blank"> <img src="img/icons8-llamada-de-conferencia-16.png"/> </a>
        </div>   

<div class="ContenedorPrincipal"> 
  <div class="px-40 pt-5 my-5 text-center border-bottom">
